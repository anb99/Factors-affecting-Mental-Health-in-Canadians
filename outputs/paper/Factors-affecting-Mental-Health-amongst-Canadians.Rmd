...
abstract: "This paper takes a look at mental health in Canada."
output:
...
Many different factors can affect our mental health. The main objective of this paper is to analyze how different socioeconomic variables influence mental health in Canadians, to see what information can be gleaned from the data we discovered, and how the statistics represent mental health in Canada.
Our paper has been divided into 5 sections. Section \@ref(data) talks about the data, the data source, the methodology of the survey and variables. Section \@ref(results) visualizes and describes the data analysis. Section \@ref(discussion) goes throught some interesting trends.
